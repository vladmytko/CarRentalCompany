package com.vladyslav.CarRentalCompany.utils;
...
public class Utils {
    ...
    public static List<CarDTO> mapCarListEntityToCarListDTOPlusBookingDTO(List<Car> carList){
        return carList.stream().map(Utils::mapCarEntityToCarDTOPlusBooking).collect(Collectors.toList());
    }
